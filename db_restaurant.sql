...
(3,'admin','Bali',0,'0','admin','202cb962ac59075b964b07152d234b70',1,1,0),
(4,'waitress','Deli',0,'0','waitress','9bc7a5c444110e35041eb91528d60a73',0,1,1),
(5,'casier','Ubud',0,'0','casier','77cf34f016313318086c77361bf90784',2,1,1);
...
CREATE TABLE `tb_transaksi` (
  ...
  `method_order` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;

/*Data for the table `tb_transaksi` */

insert  into `tb_transaksi`(`id`,`invoice`,`date`,`date_insert`,`customer`,`id_employee`,`id_menu`,`id_meja`,`qty`,`price`,`total_price`,`rest_total`,`method`,`description`,`status`,`method_order`) values 
(15,'2018-11-13 13:29:244','2018-11-13','2018-11-13 13:58:47','pio',4,1,1,1,10000,10000,0,'cash','','not paid',0);
