...
<script src="<?php echo $_SESSION['url']; ?>assets/select2.min.js"></script>
<script src="<?php echo $_SESSION['url']; ?>assets/jquery.dataTables.min.js"></script>
<script src="<?php echo $_SESSION['url']; ?>assets/chart.js"></script>